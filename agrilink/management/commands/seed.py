...
LISTINGS = [
    ...
    (2, 'Tomate',    '🍅', 1400, 'Grade B', 250, 280, 'Saint-Louis',
     ...
     'https://images.unsplash.com/photo-1561136594-7f68813d8f59?w=600&q=80'),
    ...
    (4, 'Sorgho',    '🌾', 2800, 'Grade B',  145, 160, 'Tambacounda',
     ...
     'https://images.unsplash.com/photo-1612785487897-c04b1d0db517?w=600&q=80'),
    ...
    (5, 'Niébé',     '🫘', 700,  'Grade A',  310, 330, 'Fatick',
     ...
     'https://images.unsplash.com/photo-1515543904379-3d757afe72c4?w=600&q=80'),
